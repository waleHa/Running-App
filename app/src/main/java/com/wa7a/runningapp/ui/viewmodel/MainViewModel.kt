...
import com.wa7a.runningapp.utils.SortType
...
class MainViewModel @Inject constructor(val mainRepository: MainRepository) : ViewModel() {
    ...
    private val runsSortedByTimeInMillis = mainRepository.getAllRunsSortedByTimeInMills()
    private val runsSortedByAvgSpeed = mainRepository.getAllRunsSortedByAvgSpeedInKMH()
